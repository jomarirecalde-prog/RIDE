...
?>
<section class="proposal-section completed-researches-section research-output-presented-section trainings-conducted-section" data-funding-section="<?= htmlspecialchars($sectionKey) ?>">
    ...
    <div class="proposal-table-wrap trainings-conducted-table-wrap research-output-presented-table-wrap">
        <table class="proposal-table completed-researches-table research-output-presented-table trainings-conducted-table">
            ...
            <tbody class="completed-researches-rows research-output-presented-rows" data-section="<?= htmlspecialchars($sectionKey) ?>">
