...
$pageSubtitle = 'Outcome Based Research Matrix.';
...
<div class="proposal-paper completed-researches-paper trainings-conducted-paper obr-matrix-paper">
    ...
    <?php if ($rows !== []): ?>
        <?php $readOnly = true; require APP_PATH . '/views/proposals/_obr-matrix-entries.php'; ?>
    <?php endif; ?>
